...
<div class="row">
  <div class="col-sm-12">
    <h1>Dienstplan bearbeiten <small><? echo "Heute ist der ".date('d.m.Y'); ?> (KW: <?php echo $akw ?>)</small></h1>
  </div>
	<div class="col-sm-12">
	  <p>Hier können Sie, abhängig von der Anwesenheit der Sanitäter, den Dienst für diese festlegen.<br>
          ...
          while ($anwesend = $anwesend_result->fetch_assoc()) {
                  ...
                  if ($anwesend['freitag'] == 1) {
                    ($dienst['freitag'] == 1) ? ($checked = 'checked="checked"') : ($checked = '');
                     ...
                     echo '<td><button type="submit" class="btn btn-success btn-sm" name="submit" value="dienstplan_bearbeiten">Woche speichern</button></td>';
                  echo '</tr>';
                  echo '</form>';
